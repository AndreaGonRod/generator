const DATA = {
  ...
  GREEK: {
    roots: [
      ...
      ['Amynto', 'el protector'],
      ['Anaxo', 'el soberano'],
      ['Andro', 'la fuerza del hombre'],
      ['Anemo', 'el viento'],
      ['Apollo', 'el sol'],
      ['Archi', 'el maestro'],
      ['Argo', 'lo veloz'],
      ['Aristo', 'la excelencia'],
      ['Artemi', 'la luna'],
      ['Astro', 'la estrella'],
      ['Athano', 'la inmortalidad'],
      ['Auto', 'el sí mismo'],
      ['Baccho', 'el éxtasis'],
      ['Calli', 'la hermosura'],
      ['Chari', 'la gracia'],
      ...
      ['Erythro', 'lo rojo'],
      ['Eu', 'el bien'],
      ['Eucho', 'la buena plegaria'],
      ['Eury', 'la vastedad'],
      ['Geno', 'el linaje'],
      ['Glauco', 'lo resplandeciente'],
      ['Gorgo', 'lo temible'],
      ['Hagno', 'lo puro'],
      ['Hecato', 'el centenar'],
      ['Helio', 'el resplandor'],
      ['Heraclo', 'el héroe glorioso'],
      ['Hermo', 'el mensajero'],
      ['Hero', 'el héroe'],
      ['Hiero', 'lo sagrado'],
      ['Hippo', 'el caballo'],
      ...
      ['Tacho', 'la velocidad'],
      ['Tele', 'la distancia'],
      ['Telesi', 'la culminación'],
      ['Theo', 'la deidad'],
      ['Thrasy', 'la audacia'],
      ['Timo', 'el honor'],
      ['Xantho', 'lo rubio'],
      ['Xeno', 'el extranjero'],
      ['Zeno', 'el poder de Zeus'],
      ['Zephyro', 'el céfiro'],
      ['Zoo', 'lo vital']
    ],
    simpleConnectors: [],
    complexInfixes: [],
    suffixes: [
      ['agoras', 'MALE', 'el orador de'],
      ['ander', 'MALE', 'el hombre de'],
      ['archos', 'MALE', 'el líder de'],
      ['bios', 'MALE', 'la vida de'],
      ['boulos', 'MALE', 'el consejero de'],
      ['cles', 'MALE', 'la gloria de'],
      ['crates', 'MALE', 'el poder de'],
      ['dikos', 'MALE', 'la justicia de'],
      ['doros', 'MALE', 'el regalo de'],
      ['dotos', 'MALE', 'el dado por'],
      ['genes', 'MALE', 'el nacido de'],
      ['ippos', 'MALE', 'el caballero de'],
      ['laos', 'MALE', 'el pueblo de'],
      ['machos', 'MALE', 'el luchador por'],
      ['medes', 'MALE', 'la astucia de'],
      ['menes', 'MALE', 'la fuerza de'],
      ['nikos', 'MALE', 'el victorioso en'],
      ['nomos', 'MALE', 'la ley de'],
      ['onymos', 'MALE', 'el renombre de'],
      ['patros', 'MALE', 'el padre de'],
      ['phanes', 'MALE', 'el que muestra'],
      ['phon', 'MALE', 'la voz de'],
      ['polis', 'MALE', 'el ciudadano de'],
      ['sthenes', 'MALE', 'el indomable de'],
      ['stratos', 'MALE', 'el ejército de'],
      ['timos', 'MALE', 'el honor de'],
      ['bia', 'FEMALE', 'la vida de'],
      ['boule', 'FEMALE', 'el consejo de'],
      ['clea', 'FEMALE', 'la gloria de'],
      ['dike', 'FEMALE', 'la justicia de'],
      ['dora', 'FEMALE', 'el regalo de'],
      ['dota', 'FEMALE', 'la dada por'],
      ['genia', 'FEMALE', 'la nacida de'],
      ['ippe', 'FEMALE', 'la amazona de'],
      ['krateia', 'FEMALE', 'la soberana de'],
      ['mache', 'FEMALE', 'la que lucha por'],
      ['meda', 'FEMALE', 'la astuta de'],
      ['nike', 'FEMALE', 'la victoria de'],
      ['patra', 'FEMALE', 'la patria de'],
      ['phone', 'FEMALE', 'la voz de'],
      ['polis', 'FEMALE', 'la ciudadana de'],
      ['strata', 'FEMALE', 'la estratega de'],
      ['thea', 'FEMALE', 'la diosa de'],
      ['time', 'FEMALE', 'la honrada por']
    ]
  },
  NORDIC: {
    roots: [
